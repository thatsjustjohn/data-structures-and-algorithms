...
const reversedString = (arr) => arr.split('').reduce((accumulator, currentValue) => currentValue + accumulator);
...
const extractStat = (statName, arr) => arr.reduce((accumulator, currentValue) => currentValue.stat.name === statName ? currentValue : accumulator);
...
const extractChildren = (arr) => arr.filter((value) => value.name.includes('a')).reduce((accumulator, currentValue) => currentValue.children ? accumulator.concat(currentValue.children) : accumulator, []);
