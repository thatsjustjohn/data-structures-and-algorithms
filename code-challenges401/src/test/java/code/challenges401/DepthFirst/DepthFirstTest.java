...
public class DepthFirstTest {
    ...
    public void test_depthFirst_null() {
        GraphNode gn = null;
        DepthFirst.depthFirst(gn);
    }

    @Test
    public void test_depthFirst_happy() {
        Graph g = new Graph();
        ...
        as.add(7);
        as.add(4);
        assertEquals(as,DepthFirst.depthFirst(one));

    }

    @Test
    public void test_depthFirst_one() {
        Graph g = new Graph();
        GraphNode one = g.addNode(1);
        ArrayList as = new ArrayList();
        as.add(1);
