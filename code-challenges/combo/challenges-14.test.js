...
const detectTicTacToeWin = (board) => {
  // This is gross.  but easier than loops
  // Across == helpCheck(board, 0, 0, index+1, 0, index+2, 0) index of column must be 0
  // Down == helpCheck(board, 0, 0, 0, index+1, 0, index+2)) index of row must be 0
  // Diag == helpCheck(board, 0, 0, index+1, 1, 2, 2) index of row must be 0 and column must be 0 or 2
